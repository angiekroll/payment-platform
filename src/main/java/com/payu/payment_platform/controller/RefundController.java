...
@RestController
@RequestMapping(ResourceMapping.REFUND)
@Validated
public class RefundController {
  ...
  public ResponseEntity<PaymentResponseDto> fullRefund(
      @Valid @RequestBody RefundRequestDto refundRequestDto, BindingResult resultErrors)
      throws PaymentPlatformException {

    ValidationUtils.validateInputFields(resultErrors);

    return ResponseEntity.ok(refundService.fullPaymentRefund(refundRequestDto));
